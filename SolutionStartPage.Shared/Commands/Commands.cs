namespace SolutionStartPage.Shared.Commands
{
    ...
    public static class Commands
    {
        ...
        public static RoutedCommand OpenSolution
            => _openSolution ?? (_openSolution = new RoutedUICommand("OpenSolution",
                "OpenSolution",
                typeof (Commands)));
        ...
        public static RoutedCommand AlterSolution
            => _alterSolution ?? (_alterSolution = new RoutedUICommand("AlterSolution",
                "AlterSolution",
                typeof (Commands)));
        ...
        public static RoutedCommand AlterSolutionGroup
            => _alterSolutionGroup ?? (_alterSolutionGroup = new RoutedUICommand("AlterSolutionGroup",
                "AlterSolutionGroup",
                typeof (Commands)));
